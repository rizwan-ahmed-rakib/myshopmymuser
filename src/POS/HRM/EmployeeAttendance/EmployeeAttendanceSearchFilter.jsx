...
const EmployeeAttendanceSearchFilter = ({onSearch, onFilter, initialFilters = {}}) => {
        ...
        return (
            <div className="relative">
                ...
                >
                    ...
                    <svg className={`w-4 h-4 ml-2 transition-transform ${isOpen ? 'rotate-180' : ''}`} fill="none"
                ...
                {isOpen && (
                    <div
                        className="absolute z-[60] mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                        {options.map((option) => (
                            <button
                                key={option.value}
    ...
    return (
        <div className="space-y-4" ref={dropdownRef}>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="relative flex-1 group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg className="w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors"
            ...
            <div className="flex flex-wrap items-center gap-3">
                {renderDropdown("Status", "status", ATTENDANCE_STATUS_OPTIONS ,
                ...
                {renderDropdown("Sort By", "sortBy", ADVANCE_SORT_OPTIONS,
                    <svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4" strokeWidth="2"/>
                    </svg>
                )}
            ...
            {showAdvanced && (
                <div
                    className="bg-gray-50 rounded-3xl p-6 border border-gray-200 animate-in slide-in-from-top-4 duration-300">
...
EmployeeAttendanceSearchFilter.propTypes = {
    onSearch: PropTypes.func,
    onFilter: PropTypes.func,
    initialFilters: PropTypes.object
};

export default EmployeeAttendanceSearchFilter;

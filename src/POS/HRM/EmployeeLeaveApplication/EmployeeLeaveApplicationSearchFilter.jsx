...
const EmployeeLeaveApplicationSearchFilter = ({ onSearch, onFilter, initialFilters = {} }) => {
...
EmployeeLeaveApplicationSearchFilter.propTypes = {
    onSearch: PropTypes.func,
    onFilter: PropTypes.func,
    initialFilters: PropTypes.object
};

export default EmployeeLeaveApplicationSearchFilter;

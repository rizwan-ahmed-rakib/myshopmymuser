...
//             alert(`Total payment (৳${totalPaid}) must match loan amount (৳${form.amount})`);
//             setLoading(false);
//             return;
//         }
//
...
//     const handleClose = () => {
//         setForm({
//             user: "", amount: "", loan_date: "", reason: "", repayment_start_date: "",
...
//                     <div>
//                         <h2 className="text-xl font-black uppercase tracking-tight">Add Employee Loan</h2>
//                         <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Disburse Loan with Hybrid Payment</p>
//                     </div>
...
//                             <input type="date" name="loan_date" value={form.loan_date} onChange={handleChange} className="w-full p-2 border-2 border-gray-100 rounded-xl" />
//                         </div>
//                         <div>
//                             <label className="block text-[10px] font-black text-gray-500 uppercase mb-1">Repayment Start Date</label>
//                             <input type="date" name="repayment_start_date" value={form.repayment_start_date} onChange={handleChange} className="w-full p-2 border-2 border-gray-100 rounded-xl" required />
//                         </div>
//                     </div>
//
//                     <div>
//                         <label className="block text-[10px] font-black text-gray-500 uppercase mb-1">Monthly Repayment</label>
//                         <input type="number" name="monthly_repayment_amount" value={form.monthly_repayment_amount} onChange={handleChange} className="w-full p-2 border-2 border-gray-100 rounded-xl" placeholder="Monthly Deduction" required />
//                     </div>
//
//                     <div>
//                         <label className="block text-[10px] font-black text-gray-500 uppercase mb-1">Reason</label>
//                         <textarea name="reason" value={form.reason} onChange={handleChange} className="w-full p-2 border-2 border-gray-100 rounded-xl" rows="2" placeholder="Why this loan?" />
//                     </div>
//
//                     {/* Hybrid Payment Breakdown */}
//                     <div className="bg-gray-50 p-5 rounded-2xl border-2 border-gray-100 space-y-4 shadow-inner">
//                         <label className="block text-[10px] font-black text-gray-500 uppercase mb-2">Disbursement Breakdown (Hybrid)</label>
...
//                                 <label className="text-[9px] font-black text-blue-600 uppercase block mb-1">Bank Name / Reference</label>
...
//                             <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Total Disbursed</p>
...
//                             <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Target Loan</p>

            ...
            setFilterConfig({
                ...
                filtersConfig: [
                    ...
                    { key: "status", label: "Loan Status", icon: <Activity className="w-3.5 h-3.5" />, options: [
                        { value: "all", label: "All Status" }, { value: "paid", label: "Paid" }, { value: "unpaid", label: "Unpaid" }
                    ]},
                ...
                {viewType === "grid" ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {filteredEmployees.map(emp => (
                            <EmployeeLoanCard key={emp?.id} advance={emp} onEdit={handleUpdated} onDelete={handleUpdated} />
                        ))}
                    </div>
                ) : (

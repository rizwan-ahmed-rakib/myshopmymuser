...
import EmployeeSalaryAdvanceHeader from "./EmployeeSalaryAdvanceHeader";
import EmployeeStats from "./EmployeeStats";
import EmployeeSalaryAdvanceSearchFilter from "./EmployeeSalaryAdvanceSearchFilter";
...
const EmployeeSalaryAdvanceGrid = () => {
    ...
    const fetchEmployeeSalaryAdvance = async (showLoading = true) => {
        ...
        try {
            const response = await salaryAdvanceAPI.getAll();
            setSalaryAdvance(response.data);
            calculateStats(response.data);
        } catch (error) {
            console.error("Error fetching employees:", error);
    ...
    const handleEmployeeAdded = (newEmp) => {
        setSalaryAdvance(prev => [...prev, newEmp]);
        setIsAddOpen(false);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-6">
            ...
            {/* Search and Filter */}
            <div className="mb-6">
                <EmployeeSalaryAdvanceSearchFilter

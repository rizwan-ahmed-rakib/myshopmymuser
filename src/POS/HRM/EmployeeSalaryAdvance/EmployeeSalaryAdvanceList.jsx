        ...
        <>
            <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
                <div className="overflow-x-auto">
                    ...
                    {/* Header */}
                    <div
                        className="grid grid-cols-12 px-6 py-4 bg-gray-50 text-xs font-bold text-gray-500 uppercase tracking-wider border-b">
                            ...
                            <div key={item.id}
                                ...
                                <div className="col-span-3 flex items-center gap-3">
                                    {item.user_image ? (
                                        ...
                                        <div
                                            className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-sm">

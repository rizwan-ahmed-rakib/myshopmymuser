...
const EmployeeSalaryAdvanceSearchFilter = ({ onSearch, onFilter, initialFilters = {} }) => {
...
EmployeeSalaryAdvanceSearchFilter.propTypes = {
    onSearch: PropTypes.func,
    onFilter: PropTypes.func,
    initialFilters: PropTypes.object
};

export default EmployeeSalaryAdvanceSearchFilter;

...
const UpdateSalaryAdvanceModal = ({ isOpen, onClose, onSuccess, advanceData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await api.patch(`/api/users/salary-advances/${advanceData.id}/`,
                { ...form, amount: Number(form.amount) }
            );
            onSuccess?.(res.data);
            onClose();
        ...
        >
            <div className="space-y-6">
                <div className="bg-blue-50/50 p-3 rounded-xl border border-blue-100 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Editing Advance For</p>

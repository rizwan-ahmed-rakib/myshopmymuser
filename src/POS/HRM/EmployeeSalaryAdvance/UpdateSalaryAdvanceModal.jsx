...
const UpdateEmployeeSalaryAdvanceModal = ({
    isOpen,
    onClose,
    onSuccess,
    advanceData
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await salaryAdvanceAPI.update(advanceData.id, payload);
...
UpdateEmployeeSalaryAdvanceModal.propTypes = {
...
export default UpdateEmployeeSalaryAdvanceModal;
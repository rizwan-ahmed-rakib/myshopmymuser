...
const AddEmployeeSalaryPayslipModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleEmployeeChange = (e) => {
        ...
        if (selectedEmp) {
            setForm(prev => ({ 
                ...prev, 
                user: selectedEmp.id, 
                basic_salary: parseFloat(selectedEmp.salary || 0),
                paid_cash: parseFloat(selectedEmp.salary || 0),
                paid_mobile: 0,
                paid_bank: 0
            }));
        } else {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await api.post(`/api/users/payslips/`,

...
//         setLoadingId(advance.id);
//         try {
//             await salaryPayslipAPI.approve(advance.id);
...
//                     {showDropdown && (
//                         <div className="absolute bg-white border rounded shadow right-4 mt-6 z-10">
//                             <button onClick={handleEdit} className="block px-4 py-2 text-sm">Edit</button>
//                             <button onClick={handleDelete} className="block px-4 py-2 text-sm text-red-500">Delete</button>
//                         </div>
//                     )}
//                 </div>
...
//                         />
//                     ) : (
//                         <div className="w-14 h-14 bg-blue-500 text-white flex items-center justify-center rounded-full mx-auto mb-2">
//                             {advance?.user_name?.charAt(0)?.toUpperCase() || "U"}
//                         </div>
//                     )}

//                     <h3 className="font-semibold">
//                         {advance.user_name || "Unknown"}
//                     </h3>

//                     <p className="text-xs text-gray-500">
//                         {advance.user_designation || "Staff"}
//                     </p>
//                 </div>
...
//                         <span>Basic</span>
//                         <span>৳{parseFloat(advance.basic_salary || 0)}</span>
//                     </div>

//                     <div className="flex justify-between text-green-600">
//                         <span>Allowance</span>
//                         <span>৳{parseFloat(advance.allowances || 0)}</span>
//                     </div>

//                     <div className="flex justify-between text-red-500">
//                         <span>Deduction</span>
//                         <span>৳{parseFloat(advance.deductions || 0)}</span>
//                     </div>

//                     <div className="flex justify-between font-bold border-t pt-2">
//                         <span>Net</span>
//                         <span>৳{parseFloat(advance.net_salary || 0)}</span>
//                     </div>
//                 </div>

//                 {/* Payment */}
//                 <div className="text-xs text-gray-500 mt-3 text-center">
//                     Paid: {formatDate(advance.payment_date)}
//                 </div>
//             </div>
...
const EmployeeSalaryPayslipCard = ({advance = {}, onEdit, onDelete}) => {
    ...
    const handleDelete = async () => {
        if (!window.confirm(`Delete payslip of ${user_name || "User"}?`)) return;
            ...
            <div className="bg-white rounded-xl shadow border p-4">
                ...
                <div className="flex justify-between mb-3">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        {showDropdown && (
                            <div className="absolute right-0 bg-white shadow rounded border z-10">
                                <button onClick={handleEdit} className="block px-4 py-2">Edit</button>
                                <button onClick={handleDelete} className="block px-4 py-2 text-red-500">Delete</button>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="text-center mb-4">
                    {user_image ? (
                        ...
                        <div className="w-14 h-14 bg-blue-500 text-white flex items-center justify-center rounded-full mx-auto">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <div className="text-xs text-gray-500 mt-2">
                        Payment: {formatDate(payment_date)}
                    </div>
                </div>
            </div>

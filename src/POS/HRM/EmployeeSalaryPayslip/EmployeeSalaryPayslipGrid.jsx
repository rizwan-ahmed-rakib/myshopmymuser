...
import EmployeeSalaryPayslipHeader from "./EmployeeSalaryPayslipHeader";
import EmployeeStats from "./EmployeeStats";
import EmployeeSalaryPayslipSearchFilter from "./EmployeeSalaryPayslipSearchFilter";
...
const EmployeeSalaryPayslipGrid = ({ viewType, isAddOpen, setIsAddOpen }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-6">
            ...
            {/* Search and Filter */}
            <div className="mb-6">
                <EmployeeSalaryPayslipSearchFilter
            ...
            <div className="bg-white rounded-xl shadow-sm p-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    <h2 className="text-lg font-semibold text-gray-800 mb-2 sm:mb-0">
                        {viewType === "grid" ? "Payslip/Salary Grid" : "Payslip/Salary List"}
                    </h2>
                    <div className="text-sm text-gray-500">
                        Showing {filteredEmployees.length} of {salaryPaySlip?.length || 0} employees
                    </div>
                </div>

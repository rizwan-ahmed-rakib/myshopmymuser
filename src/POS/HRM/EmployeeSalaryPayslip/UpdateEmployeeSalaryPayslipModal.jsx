...
import { 
  ...
  FaCoins, FaCalendarAlt, FaHistory, FaWallet,
  FaPlus, FaMinus
} from "react-icons/fa";
import BASE_URL_of_POS from "../../../posConfig";
            ...
            <div className="bg-white w-full max-w-3xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[95vh] border border-white/20">
                <div className="px-8 py-6 bg-gray-900 text-white flex justify-between items-center sticky top-0 z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div><h2 className="text-xl font-black uppercase tracking-tight">Edit Payslip</h2><p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">ID: #{advanceData?.id} | {advanceData?.user_name}</p></div>
                    </div>

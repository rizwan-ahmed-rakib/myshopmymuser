...
const BrandDetailsPage = () => {
    ...
    const fetchProductDetails = useCallback(async () => {
        try {
            const response = await axios.get(`${BASE_URL_of_POS}/api/products/brand/${id}/`);
                            ...
                            <div className="md:w-2/3">
                                ...
                                <div className="mt-6 border-t pt-6">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                                        <InfoCard icon={<FaShoppingCart className="text-blue-500" />} title="Created " value={`৳${product.created}`} />
                                        ...
                                        <InfoCard icon={<FaTag className="text-red-500" />} title="Brand ID" value={product.title || 'N/A'} />
                                        <InfoCard icon={<FaInfoCircle className="text-indigo-500" />} title="Category ID" value={product.id || 'N/A'} />
                                    </div>
                                </div>
                            </div>
                        </div>

...
const BrandsHeader = ({viewType, setViewType, onAddClick}) => (
    <div
        ...
        <div className="flex items-center mb-4 lg:mb-0">
            <div className="mr-6">
                <h4 className="text-xl font-bold text-gray-900">Brands</h4>
                <h6 className="text-gray-600">Manage your Brands</h6>
            </div>
        </div>

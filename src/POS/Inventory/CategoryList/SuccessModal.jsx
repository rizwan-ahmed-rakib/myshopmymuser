                ...
                <div className="bg-gray-50 rounded-lg p-4 my-4 text-left">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            {/*<p className="text-sm text-gray-500">category id: <span className="font-semibold">${parseFloat(product.id).toFixed(2)}</span></p>*/}
                            <p className="text-sm text-gray-500">category id: <span className="font-semibold">{product.id} </span></p>
                        </div>
                    </div>
                </div>

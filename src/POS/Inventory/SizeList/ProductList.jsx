...
//         try {
//             await posSizeAPI.delete(product.id);
...
const ProductList = ({ products, onUpdate }) => {
  ...
  const handleViewDetails = (p) => navigate(`/inventory/size/details/${p.id}`);
    ...
    <>
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        <div className="px-5 py-3 bg-slate-50 border-b border-slate-200">
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-4"><span className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Size</span></div>
        ...
        <div className="divide-y divide-slate-100">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-4 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg overflow-hidden border border-slate-200 shrink-0 bg-slate-100">
                    <img
                      src={product.image || "https://via.placeholder.com/150?text=S"}
                      alt={product.title || product.name}
                      className="w-full h-full object-cover"
                      onError={(e) => { e.target.src = "https://via.placeholder.com/150?text=S"; }}
                    />
                  </div>
                  <div className="min-w-0">
                    <p
                      onClick={() => handleViewDetails(product)}
                      className="text-[13px] font-medium text-slate-800 hover:text-teal-600 cursor-pointer truncate transition-colors"
                    >
                ...
                {/* Category */}
                <div className="col-span-2">
                  <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-teal-50 text-teal-700 border border-teal-100">
                    {product.category_name || "N/A"}
                  </span>
                </div>
                ...
                <div className="col-span-2">
                  <span className={`inline-flex text-[10px] font-medium px-2 py-0.5 rounded-full border ${
                    ...
                    {Number(product.stock) > 0 ? `${product.stock} units` : "Out of stock"}
                  </span>
                </div>
                ...
                <div className="col-span-2 flex items-center justify-end gap-1">
                  ...
                  <button onClick={() => handleEdit(product)} title="Edit" disabled={loadingId === product.id} className="p-1.5 text-slate-400 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {(!products || products.length === 0) && (
            <div className="py-16 text-center">
              ...
              <p className="text-[13px] font-medium text-slate-700">No sizes found</p>
              <p className="text-[12px] text-slate-400 mt-1">Add your first size to get started</p>
            </div>
          )}
        </div>
      </div>

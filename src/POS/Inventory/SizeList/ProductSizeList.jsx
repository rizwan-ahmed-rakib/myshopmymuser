...
//
// const ProductSizeList = ({products, onUpdate}) => {
 ...
 * Standardized list view for Product Sizes / Variants.
 */
const ProductSizeList = ({ products, onUpdate }) => {
    const navigate = useNavigate();
    const [loadingId, setLoadingId] = useState(null);
    ...
    const handleDelete = async (product) => {
        const displayName = product.title || product.name || "this product";
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (product) => {
                ...
                else if (stockCount <= 5) badgeType = "warning"; // লো-স্টকের জন্য ওয়ার্নিং ব্যাজ

...
const UpdateSizeModal = ({ isOpen, onClose, onSuccess, productData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await posSizeAPI.update(productData.id, data);
            ...
            if (err.response?.data) {
                ...
                alert("Error updating Size: " + JSON.stringify(err.response.data));
            } else {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center z-10">
                    <h2 className="text-2xl font-bold text-gray-800">Update Size</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                     <div className="space-y-6">
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                            <label className="block text-sm font-medium text-gray-700 mb-2">Size Image</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Size Title *</label>

    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response?.data) {
                ...
                alert("Error creating Unit: " + JSON.stringify(err.response.data));
            } else {
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="space-y-6">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                            ...
                            <input id="Unit-image-upload" type="file" name="image" accept="image/*" onChange={handleChange} className="hidden" />

...
// import ProductHeader from "./UnitHeader";
...
//
// const UnitGrid = ({viewType, isAddOpen, setIsAddOpen}) => {
//     const { posUnits, setPosUnits} = usePosUnits();
...
//         setLoading(true);
//         try {
//             const response = await posUnitAPI.getAll();
//             setPosUnits(response.data);
...
//         if (!posUnits || posUnits.length === 0) return [];
//
//         let result = [...posUnits];
//
//         // Apply search
...
//
//         return result;
//     }, [posUnits, searchQuery, filters]);
//
//     const handleProductAdded = (newProduct) => {
//         setPosUnits(prev => [newProduct, ...prev]);
//         setIsAddOpen(false);
...
//                         Showing {filteredProducts.length} of {posUnits?.length || 0} products
//                     </div>
//                 </div>
//
//                 {viewType === "grid" ? (

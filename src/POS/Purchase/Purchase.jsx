...
const Purchase = () => {
    ...
    // ট্যাবের নামগুলো কিছুটা ক্লিন ও ছোট রাখা হলো
    const tabs = [
    ...
    const isRootPurchasePath = location.pathname === '/purchase' || location.pathname === '/purchase/';
        ...
        <div className="h-full flex flex-col bg-gray-50">
            ...
            <div className="flex-1 p-2 overflow-auto">
                <div className="bg-white rounded-md shadow-sm p-2">
                    {isRootPurchasePath ? renderTabContent() : <Outlet/>}
                </div>
            </div>

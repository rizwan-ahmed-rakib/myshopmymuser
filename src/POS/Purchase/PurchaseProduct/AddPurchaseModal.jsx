    ...
    const handleBarcodeScan = async (e) => {
        ...
        try {
            ...
            if (res.data.length) {
                ...
                // Logic: If the last row is empty, use it. Otherwise, add a new row.
                setItems(prev => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (paymentProof) {
                ...
                // Append everything from payload to formData
                ...
                // When using FormData with Axios, do NOT set Content-Type manually
                // to allow the browser to set it with the correct boundary.
                res = await axios.post(`${BASE_URL_of_POS}/api/purchase/purchases/`, formData, {
                    headers: headers
                });
            } else {
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                    <div className="w-full">
                                        ...
                                        />
                                        {errors.supplier && <p className="text-red-500 text-xs mt-1 font-bold">{errors.supplier}</p>}
                                    </div>
                                    {supplier && (
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    {errors.items && <p className="bg-red-50 text-red-600 p-3 rounded-lg border border-red-100 text-sm font-bold text-center">{errors.items}</p>}
                                        ...
                                        <div key={index} className="border rounded-xl bg-white shadow-sm overflow-hidden">
                                            <div className="lg:grid lg:grid-cols-12 gap-4 p-4 items-center bg-white">
                                                ...
                                                <div className="col-span-1">
                                                    <input 
                                                        className="w-full border p-2 rounded text-right font-mono text-sm focus:border-blue-500 outline-none" 
                                                        type="number"

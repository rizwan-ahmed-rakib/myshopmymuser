...
import PurchaseReturnSuccessModal from "./PurchaseReturnSuccessModal"; // Import the new modal
...
const PurchaseDetailsPage = () => {
    ...
    const fetchPurchaseDetails = useCallback(async () => {
        try {
            const res = await axios.get(`${BASE_URL_of_POS}/api/purchase/purchases/${id}/`);

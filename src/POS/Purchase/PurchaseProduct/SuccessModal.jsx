 ...
 * Specifically tailored for Purchase success with unified printing engine.
 */
            ...
            <div className="text-center space-y-6 py-2">
                ...
                <div className="bg-gray-50 rounded-2xl p-5 space-y-4 border border-gray-100 text-left">
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Net Amount</span>
                        <span className="font-black text-gray-900">৳{netTotal.toLocaleString()}</span>
                    </div>
                    
                    <div className="pt-3 border-t border-dashed border-gray-200">
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">Amount Paid</span>
                    ...
                    <div className="pt-3 border-t-2 border-gray-200 mt-1">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-black text-rose-700 text-xl font-mono">৳{totalSupplierDue.toLocaleString()}</span>
                        </div>
                    </div>
                </div>

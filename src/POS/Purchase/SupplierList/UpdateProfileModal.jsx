...
/**
 * UpdateSupplierModal - Refactored to use BaseModal and standardized backbone layout.
 */
const UpdateSupplierModal = ({ isOpen, onClose, onSuccess, employeeData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await posSupplierAPI.update(employeeData.id, formData);
            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-5">
                    <div className="space-y-1.5">
                        ...
                        <input name="name" value={form.name} onChange={handleChange} placeholder="Supplier name" className="w-full border border-gray-200 p-3 rounded-xl font-bold text-gray-800 focus:ring-2 focus:ring-blue-100 focus:border-blue-400 outline-none transition-all" required />
                    </div>

...
import SuccessModal from "../../Purchase/SupplierDuePayment/SuccessModal";
    ...
    return (
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="relative group">
                                <label className="text-[10px] font-black text-emerald-600 uppercase mb-2 ml-1 flex items-center gap-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="number" name="paid_cash" value={form.paid_cash} onChange={handleAmountChange}
                                        className="w-full bg-emerald-50/30 border-2 border-emerald-100 pl-8 pr-4 py-4 rounded-2xl font-black text-emerald-700 focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all" />
                                </div>
                            </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea name="note" value={form.note} onChange={handleChange} rows="3"
                            ...
                            placeholder="Add any specific details about this collection update..." />
                    </div>
                    ...
                    <div className="bg-gray-900 p-8 rounded-[2rem] flex flex-col sm:flex-row justify-between items-center gap-6 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 text-center sm:text-left">
                            ...
                            <p className="text-4xl font-black text-white">
                                <span className="text-emerald-500 text-2xl mr-1">৳</span>{totalAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                            </p>
                        </div>
                        ...
                        <div className="flex gap-3 w-full sm:w-auto relative z-10">
                            ...
                            <button type="submit" disabled={loading || totalAmount <= 0}
                                className="flex-[2] bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-xl shadow-emerald-600/30 active:scale-95 hover:bg-emerald-500 disabled:bg-gray-800 disabled:text-gray-600 disabled:shadow-none transition-all flex items-center justify-center gap-2">
                                {loading ? (
        ...
        {showSuccess && (
            <SuccessModal 
                ...
                message={`Collection #${item.invoice_no} has been successfully updated with the new breakdown.`}
            />
        )}
        </>
    );

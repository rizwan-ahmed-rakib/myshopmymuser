                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                            ...
                            {employee.due_amount < 0 ? 'Payable' : employee.due_amount > 0 ?'Receivable':'Clear'}
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {showDropdown && (
                                <div
                                    ...
                                    <button
                                        onClick={() => navigate(`/sales/customer/profile/${employee.id}`)}
                            ...
                            <div className="text-center">
                                ...
                                <div className={`text-sm font-medium ${
                                    ...
                                    {employee.due_amount > 0
                                        ? `Receivable: ${employee.due_amount}`
                                        : employee.due_amount < 0
                                            ? `Payable: ${Math.abs(employee.due_amount)}` // Math.abs() ব্যবহার করে নেগেটিভ চিহ্ন (-) বাদ দেওয়া হয়েছে
                                            : 'Clear'
                                    }
                                </div>
                            </div>

            ...
            <div className="divide-y divide-gray-100">
                {products?.filter(p => p).map((product) => (
                    ...
                    >
                        <div className="grid grid-cols-12 gap-4 items-center">
                                ...
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <img
                                            ...
                                            src={product.customer_image || "https://via.placeholder.com/150"}
                            ...
                            <div className="col-span-2">
                                <p className="text-sm font-bold text-gray-900">৳{Number(product.net_total || product.netTotal).toFixed(2)}</p>
                            </div>
                ...
                {(!products || products.length === 0) && (
                    <div className="px-6 py-12 text-center">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-gray-900">No sale records</h3>
                        <p className="mt-1 text-sm text-gray-500">Your sales history will appear here.</p>
                    </div>
                )}
            </div>
        </div>

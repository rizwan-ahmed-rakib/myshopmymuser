                                            ...
                                            <tr key={index} className="text-[11px]">
                                                ...
                                                <td className="py-2 px-2 min-w-[110px]">
                                                    ...
                                                    {item.product && !item.is_unique && <span
                                                        className="text-[8px] font-bold text-blue-500">Stock: {item.stock}</span>}
                                                </td>
                                                ...
                                                <td className="py-2 px-2 text-center">
                                                    {item.is_unique ? (
                                                        ...
                                                        <div
                                                            className="flex items-center justify-center bg-gray-50 border border-gray-300 rounded-lg overflow-hidden h-6 inline-flex">
                                                            <button type="button"
                                                                    onClick={() => updateQty(index, item.quantity - 1)}
                                                                    className="w-5 h-full flex items-center justify-center bg-gray-100 hover:bg-gray-200 font-bold text-[11px]">-
                                                            </button>
                                                            <span
                                                                className="w-6 text-center text-[10px] font-bold font-mono">{item.quantity}</span>
                                                            <button type="button"
                                                                    onClick={() => updateQty(index, item.quantity + 1)}
                                                                    className="w-5 h-full flex items-center justify-center bg-gray-100 hover:bg-gray-200 font-bold text-[11px]">+
                                                            </button>
                                                ...
                                                <td className="py-2 px-2 text-right">
                                                    <span
                                                        className="font-bold font-mono text-blue-700 text-[11px] block mt-0.5">৳{item.total_price.toFixed(0)}</span>
                                                ...
                                                <td className="py-2 px-1 text-center">
                                                    <button type="button" onClick={() => removeRow(index)}
                                                            className="text-gray-400 hover:text-red-500 font-bold text-base">×
                                                    </button>
                                                </td>
                                            </tr>
                                        ))}
            ...
            <form id="posSaleForm" onSubmit={handleSubmit}
                ...
                <div
                    ...
                    <div className="flex flex-1 overflow-hidden gap-2">
                        {/* Categories List */}
                        <div
                            className="w-[28%] md:w-[25%] lg:w-[20%] border-r border-gray-200 overflow-y-auto pr-1 text-[10px] scrollbar-thin">
                        ...
                        {/* Product Cards List */}
                        <div
                            className="w-[72%] md:w-[75%] lg:w-[80%] overflow-y-auto grid gap-2 p-0.5 content-start scrollbar-thin"
                ...
                <div
                    ...
                    <div className="bg-blue-50/70 p-3 rounded-xl border border-blue-100 flex flex-col gap-2">
                        <label className="block text-[9px] font-extrabold uppercase text-blue-900 tracking-wider">
                            Customer CRM * {isWalkInActive &&
                            <span className="text-[9px] ml-2 bg-blue-600 text-white px-1.5 py-0.5 rounded font-black">🚶 Walk-In Active</span>}
                        </label>
                            ...
                            <div className="flex gap-1 shrink-0">
                                {customer && (
                                    <button
                                        type="button"
                                        onClick={() => handleViewCustomerDetails(customer.value)}
                                        className="p-1.5 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-lg transition-all duration-200 shadow-sm"
                                ...
                                <button
                                    ...
                                    className="p-1.5 bg-green-105 hover:bg-green-200 text-green-600 rounded-lg border border-green-200 transition-all duration-200 shadow-sm"
                                ...
                                {customer && !isWalkInActive && (
                                    <div className="text-right">
                                        <span
                                            className="text-[8px] text-gray-400 block font-bold uppercase">CRM Balance</span>
                                        <span
                                            className="text-xs font-black text-red-600 font-mono">৳{previousDue.toFixed(2)}</span>
                                    </div>
                                )}
                    ...
                    <div
                        className="flex-1 overflow-y-auto border border-gray-150 rounded-xl bg-gray-50/50 scrollbar-thin">
                        <table className="w-full text-left border-collapse text-xs">
                            <thead>
                            ...
                            {items.map((item, index) => (
                                <tr key={index} className="text-xs hover:bg-gray-50/60">
                                    ...
                                    <td className="py-2.5 px-2">
                                        ...
                                        />
                                        {item.error_msg &&
                                            <p className="text-red-505 text-[8px] font-bold mt-1 leading-none">{item.error_msg}</p>}
                                        {item.success_msg &&
                                            <p className="text-green-600 text-[8px] font-bold mt-1 leading-none">{item.success_msg}</p>}
                                    </td>
                                    <td className="py-2.5 px-2">
                                        <AsyncSelect
                                            loadOptions={loadProductOptions} defaultOptions={false}
                                        ...
                                        />
                                        {item.product && !item.is_unique && <span
                                            className="text-[8px] font-bold text-blue-500 mt-0.5 block">Stock: {item.stock}</span>}
                                    </td>
                                    <td className="py-2.5 px-2">
                                        <input
                                            type="number"
                                    ...
                                    <td className="py-2.5 px-2">
                                        {item.is_unique ? (
                                            <div className="text-center">
                                                 <span
                                                     className="text-[8px] font-extrabold text-amber-700 bg-amber-50 px-1 py-0.5 rounded border border-amber-200">Unique</span>
                                            </div>
                                        ) : (
                                            <div
                                                className="flex items-center justify-center bg-gray-50 border border-gray-300 rounded overflow-hidden h-7">
                                                <button type="button"
                                                        onClick={() => updateQty(index, item.quantity - 1)}
                                                        className="w-5 h-full flex items-center justify-center bg-gray-150 hover:bg-gray-200 font-extrabold text-xs">-
                                                </button>
                                                <span
                                                    className="w-6 text-center text-xs font-bold font-mono">{item.quantity}</span>
                                                <button type="button"
                                                        onClick={() => updateQty(index, item.quantity + 1)}
                                                        className="w-5 h-full flex items-center justify-center bg-gray-150 hover:bg-gray-200 font-extrabold text-xs">+
                                                </button>
                                    ...
                                    <td className="py-2.5 px-2">
                                        <div
                                            className="flex items-center border border-gray-350 rounded overflow-hidden bg-white">
                                            <select
                                    ...
                                    <td className="py-2.5 px-2 text-right">
                                         <span
                                             className="font-bold font-mono text-blue-700 text-[11px] block">৳{item.total_price.toFixed(0)}</span>
                                        {item.discount_amount > 0 &&
                                            <span
                                    ...
                                    <td className="py-2.5 px-1 text-center">
                                        <button type="button" onClick={() => removeRow(index)}
                                                className="text-gray-400 hover:text-red-500 font-extrabold text-base transition-colors p-0.5">×
                                        </button>
                                    </td>
                                </tr>
                            ))}
                    ...
                    <div className="border-t border-gray-100 pt-3 flex flex-col gap-3 shrink-0 bg-white">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div
                                ...
                                <label
                                    className="block text-[9px] font-black uppercase text-green-700 tracking-wider mb-1">
                                    Overall Invoice Discount
                                </label>
                                <div className="flex gap-2 items-center">
                                    <select
                                        className="border p-1 rounded bg-white outline-none text-[10px] font-bold flex-1"
                                        value={globalDiscountType}
                                        onChange={(e) => setGlobalDiscountType(e.target.value)}>
                                    ...
                                    <input type="number"
                                           className="w-full border p-1 rounded outline-none font-bold text-xs bg-white font-mono focus:border-green-500 flex-1"
                                           placeholder="0.00" value={globalDiscountValue || ""}
                                           onChange={(e) => setGlobalDiscountValue(Number(e.target.value))}/>
                                </div>
                            </div>
                        ...
                        <div
                            className="bg-gray-900 text-white p-3 rounded-xl flex items-center justify-between gap-4 shadow-md">
                            <div className="flex items-center gap-6 text-xs">
                                ...
                                <div className="text-emerald-400 font-bold text-sm">
                                    Net: <span
                                    className="font-mono font-black text-base ml-1">৳{netTotal.toFixed(0)}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-2 shrink-0">
                                <button type="button"
                                        ...
                                        className="px-3 py-1.5 border border-gray-700 rounded-lg text-gray-400 hover:text-white hover:border-gray-500 font-bold text-[10px] uppercase tracking-wider transition-all">
                                    Clear
                                </button>
                                <button type="button"
                                        onClick={() => {
                                        ...
                                        className="px-4 py-1.5 font-black rounded-lg text-xs uppercase tracking-widest text-white shadow-lg bg-blue-600 hover:bg-blue-700 shadow-blue-500/20 transition-all active:scale-98">
                                    💳 Make Payment
                                </button>
                            </div>
                        </div>

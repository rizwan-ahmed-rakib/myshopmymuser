// // UpdateUserSalarySuccessPopup.jsx - Separate component for success messages
// import React, { useEffect } from "react";
//
// const UpdateProfileSuccessPopup = ({ message, onClose, duration = 3000 }) => {
//     useEffect(() => {
...
//                         <p className="text-xs opacity-90 mt-1">Profile updated successfully</p>
//                     </div>
//                     <button
//                         onClick={onClose}
//                         className="ml-auto -mx-1.5 -my-1.5 text-white hover:text-gray-100 rounded-lg p-1.5 inline-flex h-8 w-8"
//                     >
...
// };
//
// export default UpdateProfileSuccessPopup;



// components/employees/SuccessPopup.jsx
import React, { useEffect } from "react";

...
const ModuleShell = ({
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50">
            ...
            <div className="bg-white border-b px-4 py-3 flex flex-col md:flex-row md:items-start md:justify-between sticky top-0 z-30 shadow-sm gap-4 select-none">
                    ...
                    <div className="relative">
                        ...
                        {isActionOpen && (
                            <>
                                ...
                                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl z-50 py-2 animate-in fade-in zoom-in-95 duration-150">
                                    {isRootPath && (
                                        <>

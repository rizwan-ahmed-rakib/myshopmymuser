...
// import handleCategoryAdded from "../Inventory/CategoryList/CategoryGrid.jsx"
...
const AddNewDropdown = ({onClose}) => {
    ...
    const closeAll = () => {
        setActiveModal(null);
        onClose?.(); // navbar dropdown close
    };

    const handleSuccess = (data) => {
        setSuccessData(data);   // 🔥 global success
        const item = items.find(i => i.key === activeModal);

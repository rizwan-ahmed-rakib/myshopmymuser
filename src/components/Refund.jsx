      ...
      <div className="flex-1 bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600">ঘরেরবাজার এর রিফান্ড সংক্রান্ত নীতিমালা</p>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-3">ঘরেরবাজার যখন আপনার রিফান্ডের ধরন অনুযায়ী আপনার রিফান্ড প্রক্রিয়া করে তখন থেকে রিফান্ডের সময়/প্রক্রিয়া শুরু হয়।</p>
                </div>
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-700 mb-4">ঘরেরবাজার নিম্নলিখিত রিফান্ডের ধরন অনুযায়ী আপনার রিফান্ড প্রক্রিয়া করবে।</p>
            ...
            <div className="p-6">
              ...
              <div className="bg-gray-50 p-5 rounded-lg mb-6">
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  ...
                  <li>যদি পণ্যটি ঘরেরবাজার এর প্যাকেজিং/বাক্সে সরবরাহ করা হয়, তবে একই প্যাকেজিং/বাক্সটি ফেরত দিতে হবে।</li>
              ...
              <div className="bg-orange-50 p-5 rounded-lg">
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  ...
                  <li>আপনার প্যাকেজটি ড্রপ-অফ স্টেশন/পিকআপ এজেন্টের কাছে হস্তান্তর করার সময়, দয়া করে ঘরেরবাজারের রিটার্ন স্বীকৃতি পত্রটি সংগ্রহ করুন এবং ভবিষ্যতের রেফারেন্সের জন্য সংরক্ষণ করুন।</li>
                </ul>
              </div>
            </div>
          </div>

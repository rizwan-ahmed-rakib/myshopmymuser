...
const Cart = ({isCartOpen, setIsCartOpen}) => {
    ...
    return (
        <>
            ...
            <div
                // className={`fixed top-0 right-0 h-full w-full md:w-96 bg-white z-50 shadow-lg transform transition-transform duration-300 ${
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p className="text-green-500 font-semibold">
                                                unit-price {item.item_price} x quantity {item.quantity} =

...
import {useAbout} from "../../context_or_provider/myshop/AboutContext";
            ...
            <div className="px-4 sm:px-6 py-1">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-2">
                        ...
                        <Search className="text-green-500 w-5 h-5 dark:text-green-400"/>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center space-x-4 sm:space-x-6">
                        ...
                        <Link to="/profile" className="flex flex-col items-center group">
                            ...
                            <span
                                ...
                                className="hidden md:block text-xs text-green-500 opacity-0 group-hover:opacity-100 transition dark:text-orange-400">
                Account
              </span>
                        </Link>
                        ...
                        >
                            <ShoppingBag
                                ...
                                className="text-green-500 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 dark:text-orange-400"/>
                ...
                {isSearchOpen && (
                    <div className="md:hidden mt-3 flex items-center space-x-2">
                        ...
                        <button
                            ...
                            className="text-green-500 p-2 dark:text-green-400"
                        >
                            <X className="w-5 h-5"/>
                        </button>
                    </div>
